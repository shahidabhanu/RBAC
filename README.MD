...
# 🤖 FinBot – RAG-Based Chatbot with Role-Based Access Control(RBAC)
...
🤖 Local LLM via Ollama (phi-3 / mistral)
...
🔍 Document chunking, embedding & metadata filtering
...
⚠️ Cache is reset automatically when the backend restarts.
----
